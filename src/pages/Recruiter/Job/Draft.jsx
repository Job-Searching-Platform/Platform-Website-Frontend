  ...
  return (
    <div class="mt-9 flex flex-col space-y-10 sm:flex-row sm:space-x-6 sm:space-y-0 md:flex-col md:space-x-0 md:space-y-10 xl:flex-row xl:space-x-6 xl:space-y-0">
      ...
      <div class="w-full">
        ...
        <div class="space-y-2">
          <div class="rounded-sm border border-amber-300 bg-amber-50 px-5 py-4 shadow-lg">
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    ...
                    src="./images/company-icon-05.svg"
                    width="36"
                    height="36"
                    alt="Company 05"
                  />
              ...
              <div class="flex items-center space-x-4 pl-10 md:pl-0">
                ...
                <div class="inline-flex rounded-full bg-amber-100 px-2.5 py-1 text-center text-xs font-medium text-amber-600">
                  Featured
                </div>
          ...
          <div class="rounded-sm border border-slate-200 bg-white px-5 py-4 shadow-lg">
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-06.svg"
                    width="36"
                    height="36"
                    alt="Company 06"
                  />
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-03.svg"
                    width="36"
                    height="36"
                    alt="Company 03"
                  />
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-07.svg"
                    width="36"
                    height="36"
                    alt="Company 07"
                  />
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-08.svg"
                    width="36"
                    height="36"
                    alt="Company 08"
                  />
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-01.svg"
                    width="36"
                    height="36"
                    alt="Company 01"
                  />
                ...
                <div>
                  ...
                  <div class="text-sm">Freelance / Remote / London, UK</div>
                </div>
              </div>
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                ...
                <div>
                  ...
                  <div class="text-sm">Contract / Remote / Miami, FL</div>
                </div>
              </div>
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                ...
                <div>
                  ...
                  <div class="text-sm">Full-time / Remote / Lincoln, NE</div>
                </div>
              </div>
              <div class="flex items-center space-x-4 pl-10 md:pl-0">
                <div class="whitespace-nowrap text-sm italic text-slate-500">
            ...
            <div class="items-center justify-between space-y-4 space-x-2 md:flex md:space-y-0">
              <div class="flex items-start space-x-3 md:space-x-4">
                <div class="mt-1 h-9 w-9 shrink-0">
                  <img
                    class="h-9 w-9 rounded-full"
                    src="./images/company-icon-02.svg"
                    width="36"
                    height="36"
                    alt="Company 02"
                  />
                ...
                <div>
                  ...
                  <div class="text-sm">Contract / Remote / Anywhere</div>
                </div>
              </div>
              <div class="flex items-center space-x-4 pl-10 md:pl-0">
                <div class="whitespace-nowrap text-sm italic text-slate-500">
