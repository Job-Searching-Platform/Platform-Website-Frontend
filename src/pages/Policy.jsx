...
const Policy = () => {
  return (
    <div className="mx-auto max-w-[37.5rem] pt-20 pb-24 text-center">
      <div className="relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]">
        ...
        <div className="relative px-4 text-left sm:px-6 lg:px-8">
          <div className="prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600 mx-auto max-w-[40rem]">
            ...
            <h2 className="mb-2 text-xl font-bold">Purchases</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">The rights of users</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Privacy of children</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Newsletters</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Data breach</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Legal disclosure</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Changes and amendments</h2>
            <p className="mb-8 text-slate-600">
            ...
            <h2 className="mb-2 text-xl font-bold">Contacting us</h2>
            <p className="mb-8 text-slate-600">
