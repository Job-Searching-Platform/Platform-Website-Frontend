...
const Policy = () => {
  return (
    <div className="mx-auto max-w-[37.5rem] pt-20 text-center pb-24">
      <div class="relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]">
        ...
        <div class="relative text-left px-4 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-[40rem] prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600">
            <p className="text-slate-600 mb-8">
              ...
              ("User", "you" or "your") may provide through the Tailwind UI
              website (tailwindui.com) or in the course of purchasing any
              Tailwind UI products (collectively, "Website"). The Policy also
            ...
            <p className="text-slate-600 mb-8">
              ...
              able to login to the Website and access any purchased Tailwind UI
              products.
            </p>
            <h2 className="font-bold mb-2 text-xl">
            ...
            <h2 className="font-bold mb-2 text-xl">Purchases</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">The rights of users</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Privacy of children</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Newsletters</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Cookies</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Links to other websites</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Information security</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Data breach</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Legal disclosure</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Changes and amendments</h2>
            <p className="text-slate-600 mb-8">
            ...
            <h2 className="font-bold mb-2 text-xl">Contacting us</h2>
            <p className="text-slate-600 mb-8">
