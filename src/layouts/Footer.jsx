        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8 space-y-4">
              <div>
                <h2 className="ml-20">Download the APP</h2>
              </div>
          ...
          <p className="text-sm text-center text-gray-600">
            Copyright © 2023 Jobest Inc. All rights reserved.
          </p>
        </div>
      </section> */}
      <section
          ...
          <span className="i9chubn dir dir-ltr">
            <svg width="26" height="12" fill="none">
              <rect
                ...
                style={{ darkreaderInlineFill: "red" }}
                // style="--darkreader-inline-fill: #fbeed6"
              ></rect>
              <path
                ...
                // style="--darkreader-inline-fill: #869ba7"
              ></path>
              <path
                ...
                // style="--darkreader-inline-stroke: #869ba7"
              ></path>
              <path
                ...
                // style="--darkreader-inline-stroke: #fbeed6"
              ></path>
              <rect
                x="0.5"
                y="0.5"
